...
contract CoinmecaToken is Initializable, OwnableUpgradeable, ERC20PausableUpgradeable {
  ...
  function initialize(address _locker, address _supplier)
  external 
  initializer {
    __Ownable_init();
    ...
    _mint(_supplier, 100000000 ether);
  }
